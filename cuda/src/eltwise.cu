// FROM https://github.com/scroll-tech/plonky3-gpu/blob/openvm-v2/gpu-backend/src/cuda/kernels/eltwise.cu
...
extern "C" __global__ void poly_multiply_add(
    Fp *poly_d,
    Fp *poly_a,
    Fp *poly_b,
    Fp *poly_c,
    ...
    if (totIdx < count) {
        poly_d[totIdx] = poly_a[totIdx] * poly_b[totIdx] + poly_c[totIdx];
    }
}
...
extern "C" __global__ void eltwise_sum_fpext(
    Fp *out,
    const FpExt *in,
...
// END OF FILE gpu-backend/src/cuda/kernels/eltwise.cu

// TODO: delete extern there and add launcher here