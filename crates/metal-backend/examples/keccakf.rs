...
//! Multi-threaded: runs multiple proofs across OS threads.
...
fn main() {
    ...
    // NUM_THREADS: number of OS threads to use
    ...
    for worker_idx in 0..num_threads {
        ...
        handles.push(std::thread::spawn(move || {
            for t in start_task..end_task {
                ...
                println!("[task {t}] Starting Metal proof");
                let mut engine = BabyBearPoseidon2MetalEngine::new(make_params());
