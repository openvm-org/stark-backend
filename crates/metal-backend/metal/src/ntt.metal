...
/// Bit reversal permutation for FracExt values.
kernel void bit_reverse_frac_ext(
    device FracExt *d_out [[buffer(0)]],
    const device FracExt *d_in [[buffer(1)]],
    constant uint32_t &lg_domain_size [[buffer(2)]],
    constant uint32_t &padded_poly_size [[buffer(3)]],
    constant uint32_t &poly_count [[buffer(4)]],
    uint2 gid [[thread_position_in_grid]]
