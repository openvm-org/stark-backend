...
//!
//! 1. A pooled staging allocator for host-to-device copies ([`take`] /
//!    [`give_back`] / [`register_region`]).
//! 2. [`PinnedBuffer`], a fixed-capacity pinned buffer for low-latency
//!    device-to-host readbacks (see [`crate::copy::MemCopyD2H::to_pinned_on`]).
//!
//! # Staging pool
//!
