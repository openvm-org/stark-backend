...
// ===========================================================================
// Non-power-of-two trace heights (chunked stacking) — reference col-major backend
// ===========================================================================

#[test_case(2, 6, 12, 20 ; "l2 basic chunked pair")]
#[test_case(2, 6, 24, 28 ; "l2 tallest non pow2")]
#[test_case(2, 6, 12, 16 ; "l2 mixed with pow2")]
#[test_case(0, 8, 5, 7 ; "l0 odd heights")]
#[test_case(3, 5, 24, 40 ; "l3 chunked pair")]
#[test_case(2, 6, 2, 12 ; "l2 sub l_skip sender")]
