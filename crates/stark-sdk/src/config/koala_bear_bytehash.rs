...
pub type KoalaBearByteHashConfig<H> = StarkConfig<Pcs<H>, RapPhase<H>, Challenge, Challenger<H>>;

pub struct KoalaBearByteHashEngine<H>
where
    H: CryptographicHasher<u8, [u8; 32]> + Clone,
{
    pub fri_params: FriParameters,
    pub config: KoalaBearByteHashConfig<H>,
    pub byte_hash: H,
    pub max_constraint_degree: usize,
}

impl<H> StarkEngine<KoalaBearByteHashConfig<H>> for KoalaBearByteHashEngine<H>
where
    H: CryptographicHasher<u8, [u8; 32]> + Clone + Send + Sync,
{
    fn config(&self) -> &KoalaBearByteHashConfig<H> {
        &self.config
    }
...
pub fn default_engine<H>(byte_hash: H) -> KoalaBearByteHashEngine<H>
where
    H: CryptographicHasher<u8, [u8; 32]> + Clone,
{
    ...
    H: CryptographicHasher<u8, [u8; 32]> + Clone,
{
    ...
    KoalaBearByteHashConfig::new(pcs, rap_phase)
}

pub trait KoalaBearByteHashEngineWithDefaultHash<H>
where
    H: CryptographicHasher<u8, [u8; 32]> + Clone,
{
    fn default_hash() -> H;
...
impl<H: CryptographicHasher<u8, [u8; 32]> + Clone + Send + Sync>
    StarkFriEngine<KoalaBearByteHashConfig<H>> for KoalaBearByteHashEngine<H>
where
    KoalaBearByteHashEngine<H>: KoalaBearByteHashEngineWithDefaultHash<H>,
{
