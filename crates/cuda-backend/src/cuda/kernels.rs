...
pub mod quotient {
    ...
    extern "C" {
        fn _cukernel_quotient_selectors(
            ...
            inv_vanishing: *mut std::ffi::c_void,
            log_n: u64,
            coset_log_n: u64,
            shift: u32,
        ) -> i32;
        ...
        fn _cukernel_quotient(
            ...
            d_inv_vanishing: *const std::ffi::c_void,
    ...
    pub unsafe fn quotient_global_or_local<F, EF, R>(
        ...
        d_inv_vanishing: &DeviceBuffer<F>,
