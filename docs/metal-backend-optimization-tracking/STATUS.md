...
| [6](./milestone-6.md) | Device-Aware `batch_ntt_small` Tuning | completed | codex | `perf/m6` |  | 2026-02-20 | `batch_ntt_small` launch config now device-aware; merged into `metal-backend` |
