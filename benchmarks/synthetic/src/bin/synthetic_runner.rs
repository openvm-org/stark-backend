...
use openvm_stark_sdk::config::app_params_with_128_bits_security;
...
/// Use the production `app_params_with_128_bits_security` config —
/// the standard 128-bit-security params. The captured distribution
...
fn build_params(max_log_height: usize) -> SystemParams {
    app_params_with_128_bits_security(max_log_height)
}
