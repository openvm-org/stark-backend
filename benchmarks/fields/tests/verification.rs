...
fn verify_field(
    ...
    if inv_failures[0] != 0 {
        return Err(format!("Inversion test failed with {} failures", inv_failures[0]));
    }
    if distrib_failures[0] != 0 {
        return Err(format!("Distributivity test failed with {} failures", distrib_failures[0]));
    }
...
fn test_fp4_verification() {
    verify_field(TEST_ELEMENTS, 4, init_fp4, verify_inv_fp4, verify_distrib_fp4)
        .expect("Fp4 verification failed");
}

#[test]
fn test_fp5_verification() {
    verify_field(TEST_ELEMENTS, 5, init_fp5, verify_inv_fp5, verify_distrib_fp5)
        .expect("Fp5 verification failed");
}

#[test]
fn test_fp6_verification() {
    verify_field(TEST_ELEMENTS, 6, init_fp6, verify_inv_fp6, verify_distrib_fp6)
        .expect("Fp6 verification failed");
}

#[test]
fn test_fp2x3_verification() {
    verify_field(TEST_ELEMENTS, 6, init_fp2x3, verify_inv_fp2x3, verify_distrib_fp2x3)
        .expect("Fp2x3 verification failed");
}

#[test]
fn test_fp3x2_verification() {
    verify_field(TEST_ELEMENTS, 6, init_fp3x2, verify_inv_fp3x2, verify_distrib_fp3x2)
...
fn test_kb5_verification() {
    verify_field(TEST_ELEMENTS, 5, init_kb5, verify_inv_kb5, verify_distrib_kb5)
        .expect("Kb5 verification failed");
}

#[test]
fn test_kb6_verification() {
    verify_field(TEST_ELEMENTS, 6, init_kb6, verify_inv_kb6, verify_distrib_kb6)
        .expect("Kb6 verification failed");
}

#[test]
fn test_kb2x3_verification() {
    verify_field(TEST_ELEMENTS, 6, init_kb2x3, verify_inv_kb2x3, verify_distrib_kb2x3)
        .expect("Kb2x3 verification failed");
}

#[test]
fn test_kb3x2_verification() {
    verify_field(TEST_ELEMENTS, 6, init_kb3x2, verify_inv_kb3x2, verify_distrib_kb3x2)
